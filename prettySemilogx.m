function [fig, ax] = prettySemilogx(varargin)
...
[XTicks, XTickLabels] = createLogTicksAndLabels(XMin, XMax, NXTicks);
...
ax.XAxis.Limits = double([sym(10) ^ XMin sym(10) ^ XMax]);
...
ax.XLim = double([sym(10) ^ XMin sym(10) ^ XMax]);
...
% Create border
if UseBorder == true
    line([sym(10) ^ XMin sym(10) ^ XMax sym(10) ^ XMax sym(10) ^ XMin sym(10) ^ XMin], ...
