function prettyLogLog(varargin)
...
if symtoggle == 1
    ...
    XFigWidth = simplify((PaperPoints - (sym(2) * PaperMarginPoints)) * sym(TextWidthScale), 'Steps', 100);
    ...
    CBarPosition = simplify([(sym(1.05) * BoxMarginWidth) + XAxisWidth BoxMarginWidth sym(0.2) * BoxMarginWidth YAxisWidth], 'Steps', 100);
    ...
    CBarPosition = [(1.05 * BoxMarginWidth) + XAxisWidth BoxMarginWidth 0.2 * BoxMarginWidth YAxisWidth];
